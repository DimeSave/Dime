        ...
        <div className="grid gap-6 md:grid-cols-3 xl:gap-x-12">
          ...
          />
                ...
                <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                  ...
                  <ul className="mx-auto flex list-inside justify-center lg:justify-start">
                    <a href=" https://github.com/Samuel-Adeyeye" className="px-2">
                    ...
                    <a href=" https://twitter.com/I_am_Adeyeye" className="px-2">
                    ...
                    <a href="https://www.linkedin.com/in/samuel-adeyeye" className="px-2">
          ...
          />
                ...
                <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                  ...
                  <p className="mb-4 text-neutral-500 dark:text-neutral-300">Blockchain Developer</p>
                  <ul className="mx-auto flex list-inside justify-center lg:justify-start">
                    <a href="https://github.com/AJTECH0001" className="px-2">
                    ...
                    <a href="https://twitter.com/Omoalade62" className="px-2">
                    ...
                    <a href="https://www.linkedin.com/in/alade-jamiu-damilola-394b05292/" className="px-2">
          ...
          />
                ...
                <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                  ...
                  <ul className="mx-auto flex list-inside justify-center lg:justify-start">
                    <a href="https://github.com/Qazman-Bandwidth" className="px-2">
                    ...
                    <a href="https://twitter.com/qazman001" className="px-2">
                    ...
                    <a href="https://www.linkedin.com/in/kazeem-lukman-b01476178/" className="px-2">
