...
const Signup = () => {
  ...
  const updateField = (field, value) => {
    setValues((prevalue) => ({...prevalue, [field]: value
    }))
  }
    ...
    <div class="max-w-md w-full mx-auto relative z-50">
      ...
      <div class="border border-gray-300 bg-white rounded-md p-8">
        <form class="w-full">
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="relative flex items-center">
                <input value={values.firstName} onChange={(event) => updateField("firstName", event.target.value) } name="name" type="text" required class="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter name" />
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input value={values.email} onChange={(event) => updateField("email", event.target.value)} name="email" type="email" required class="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter email" />
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input value={values.password} onChange={(event) => updateField("password", event.target.value)} name="password" type="password" required class="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter password" />
          ...
          <div class="!mt-10">
            <button onClick={() => handleSubmit() } type="button" class="w-full py-3 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
              Create an account
            </button>
          </div>
