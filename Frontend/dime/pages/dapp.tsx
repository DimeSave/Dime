...
const Dapp = () => {
  ...
  if (!isConnected)
    return (
      <div className="flex text-center min-h-screen flex-col items-center justify-between p-52">
        <div>
          <p className="text-6xl">
            Embark on the decentralized revolution! Connect your wallet to get
            started
          </p>
  ...
  return (
    <div className=" m-10 ">
      <div className="py-2 px-6 bg-[#f8f4f3] mb-5  flex items-center shadow-md shadow-black/5  top-0 left-0 z-30">
        <Link href={"/"}>
          <Image src="/Dime.jpg" width={100} height={100} alt="DIME" />
        </Link>
